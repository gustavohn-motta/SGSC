        ...
        <div class="p-5 mb-4 bg-light rounded-3">
            <div class="container-fluid py-5">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a class="btn btn-primary btn-lg" href="forms_servico.php" role="button">
                ...
                <h1 class="display-5 fw-bold">Serviços
                </h1>
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        $resultado = selectFull('servicos');?>
                        <?php foreach($resultado as $servico):?>
                        <tr>
                            <th scope="row"><?= $servico['id'];?></th>
                            <td><?= NomeById($servico['cliente_id']) ?></td>
                            <td><?= $servico['dt_serv']?></td>
                            <td>R$ <?= $servico['valor_total'] ?></td>
                            <td class="ml-5" style="width: 27%;">
                                <div class="btn-group" role="group">
                                    <a class="btn btn-info text-light" href="unico-servico.php?id=<?= $servico['id']?>">
